...
options_options.insert = "head";
options_options.singleton = false;

var update = injectStylesIntoStyleTag_default()(options/* default */.Z, options_options);
...
class ConfigForm extends react.Component {
    ...
    render() {
        return (react.createElement(react.Fragment, null,
            react.createElement(Title, { text: 'Basic settings' }),
            react.createElement("form", { onSubmit: this.handleSubmit },
                react.createElement("div", { className: "config-row config-lower-bound" },
                    react.createElement("label", null,
                        "Ignore elements smaller than:",
                        react.createElement("input", { name: "widthLowerBound", type: "number", required: true, min: 0, ref: this.widthLowerBoundInput, defaultValue: this.props.widthLowerBound }),
                        "px width, or",
                        react.createElement("input", { name: "heightLowerBound", type: "number", required: true, min: 0, ref: this.heightLowerBoundInput, defaultValue: this.props.heightLowerBound }),
                        "px height.")),
                react.createElement("div", { className: "config-row config-ignore-percentage" },
                    react.createElement("label", null,
                        "Ignore elements smaller than:",
                        react.createElement("input", { name: "areaIgnorePercentage", type: 'number', required: true, min: 0, max: 1, step: "0.01", ref: this.areaIgnorePercentageInput, defaultValue: this.props.areaIgnorePercentage }),
                        "\u00D7 (the visible area of largest element in the viewport).")),
                react.createElement("div", { className: "config-row config-hotkey" },
                    react.createElement("label", null,
                        "HotKey:",
                        react.createElement("input", { name: "hotKey", type: "text", required: true, maxLength: 1, ref: this.hotKeyInput, defaultValue: this.props.hotKey }),
                        "Ctrl:",
                        react.createElement("input", { name: "hotkeyCtrl", type: "checkbox", ref: this.hotkeyCtrlInput, defaultChecked: this.props.hotkeyCtrl }),
                        "Alt:",
                        react.createElement("input", { name: "hotkeyAlt", type: "checkbox", ref: this.hotkeyAltInput, defaultChecked: this.props.hotkeyAlt }))),
                react.createElement("div", { className: "submit" },
                    react.createElement("button", { type: "submit" }, " submit "),
                    react.createElement("button", { type: "reset" }, " reset "))),
            react.createElement(Title, { text: "Automation" }),
            react.createElement(MatchList, { list: this.state.matchList, handleDel: this.handleDel, toggleEnableState: this.toggleEnableState }),
            react.createElement("form", { onSubmit: this.handleAddMatch },
                react.createElement("div", { className: "config-row config-automation" },
                    react.createElement("label", null,
                        "Match URL:",
                        react.createElement("input", { ref: this.matchRef, placeholder: "regular expression", type: "text", required: true }),
                        "CSS selector (optional):",
                        react.createElement("input", { ref: this.selectorRef, type: "text" }),
